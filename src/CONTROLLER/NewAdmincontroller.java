...
import VIEW.NewAdminview;
import DAO.NewAdminDAO;

import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;

public class NewAdmincontroller {
    private NewAdminmodel mymodel1;
    private NewAdminview myview1;
    private NewAdminDAO newAdminDAO;

    public NewAdmincontroller(NewAdminview myView1) {
        this.myview1 = myView1;
        this.newAdminDAO = new NewAdminDAO();
        myview1.addLoginListner(new RegisterListener());
    }
...
//                     myview1.validation();
    ...
    public boolean checkMyData(NewAdminmodel mymodel1) {
        return newAdminDAO.checkMyData(mymodel1);
    }
}
