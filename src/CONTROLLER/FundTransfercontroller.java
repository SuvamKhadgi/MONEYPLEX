...
public class FundTransfercontroller {
    ...
    private FundTransferview view;
    private FundTransferDAO fundTransferDAO;

    public FundTransfercontroller(FundTransferview view) {
        this.view = view;
        this.fundTransferDAO = new FundTransferDAO();
        new RegisterListener().actionPerformed();
    }
    ...
    public boolean checkMyData(FundTransfermodel model) {
        return fundTransferDAO.checkMyData(model);
    }

    public void checkMyDataa() {
        fundTransferDAO.checkMyDataa(view);
    }
}
